...
#    Updated: 2024/10/22 16:15:04 by drenassi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			= ft_args.c ft_check_errors.c ft_lst.c ft_lst2.c \
				ft_split.c ft_utils.c ft_utils2.c ft_swap.c ft_push.c \
				ft_rotate.c ft_reverse_rotate.c ft_tiny_sort.c ft_cost.c \
				ft_position.c ft_sort.c
...
define save_files_changed_bonus
	FILE_CPP=`echo $(SRCS) $(CHECKER_SRCS)`; \
	FILE_OBJ=`find objs -type f -name '*.o' 2>/dev/null | sed 's/objs\///'`; \
	TO_COMPILE=`echo $$FILE_CPP | wc -w`; \
	for FILE in $$FILE_CPP; do \
		for OBJ in $$FILE_OBJ; do \
...
##################################### BONUS ####################################
.PHONY:																		bonus
bonus: header setup_bonus $(CHECKER)
	@rm -rf .files_changed
	@echo ""
